...
// 		Return(&contracts.LinkAddResponse{ShortedUrl: "abc1234"}, http.StatusCreated)
...
// 	var resp contracts.LinkAddResponse
...
// 	svc := new(mocks.MockLinkService)
// 	svc.On("ExtractFullLink", contracts.ShortLinkRequest{ShortLink: "abc1234"}).
// 		Return(&contracts.LinkExtractResponse{FullUrl: "https://example.com"}, http.StatusFound)
...
// 	svc := new(mocks.MockLinkService)
// 	svc.On("ExtractFullLink", contracts.ShortLinkRequest{ShortLink: "missing"}).
// 		Return(nil, http.StatusInternalServerError)
